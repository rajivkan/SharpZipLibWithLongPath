...
namespace ICSharpCode.SharpZipLib.GZip 
{
	...
	/// 	{
	///			using (Stream inStream = new GZipInputStream(Alphaleonis.Win32.Filesystem.File.OpenRead(args[0])))
	///			using (FileStream outStream = Alphaleonis.Win32.Filesystem.File.Create(Alphaleonis.Win32.Filesystem.Path.GetFileNameWithoutExtension(args[0]))) {
