...
namespace ICSharpCode.SharpZipLib.GZip 
{
	...
	/// 	{
	/// 			using (Stream s = new GZipOutputStream(Alphaleonis.Win32.Filesystem.File.Create(args[0] + ".gz")))
	/// 			using (FileStream fs = Alphaleonis.Win32.Filesystem.File.OpenRead(args[0])) {
