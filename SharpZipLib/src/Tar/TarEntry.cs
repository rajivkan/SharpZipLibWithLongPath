...
namespace ICSharpCode.SharpZipLib.Tar 
{
	...
	public class TarEntry : ICloneable
	{
		...
		public bool IsDirectory {
			get {
				if (file != null) {
					return Alphaleonis.Win32.Filesystem.Directory.Exists(file);
				}
...
/*
			if (Alphaleonis.Win32.Filesystem.Path.DirectorySeparatorChar == '\\') 
			{
...
*/
            ...
            if (Alphaleonis.Win32.Filesystem.Directory.Exists(file))
            {
				...
				header.Size     = new FileInfo(file.Replace('/', Alphaleonis.Win32.Filesystem.Path.DirectorySeparatorChar)).Length;
			}

            header.ModTime = Alphaleonis.Win32.Filesystem.File.GetLastWriteTime(file.Replace('/', Alphaleonis.Win32.Filesystem.Path.DirectorySeparatorChar)).ToUniversalTime();
			header.DevMajor = 0;
			header.DevMinor = 0;
		}
		...
		{
			if ( (file == null) || !Alphaleonis.Win32.Filesystem.Directory.Exists(file)) {
